...
setwd("C:/Users/jmartinez/Desktop/JC/OneDrive - El Colegio de México A.C/Proyecto/FLACSO_R_22052019/Datos/2016trim1_dbf")
...
#Verificar la recodificacion de las 3 variables con un tabulado simple
wtd.table(SD$SEXO)
